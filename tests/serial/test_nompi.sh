...
test_run_program "Running pnFAM strength (this should take a couple of minutes at most)" \
   "$pnfam_path/pnfam_nompi.x default_str.in > test_output_pnfam.out" \
...
test_run_program "Running pnFAM contour (this should take a couple of minutes at most)" \
   "$pnfam_path/pnfam_nompi.x default_contour_gt0.in >> test_output_pnfam.out" \
   "There was an error running pnfam_nompi.x."

test_run_program "Running pnFAM contour (this should take a couple of minutes at most)" \
   "$pnfam_path/pnfam_nompi.x default_contour_gt1.in >> test_output_pnfam.out" \
   "There was an error running pnfam_nompi.x."
...
test_run_program "Running contour integration (this should take less than a minute)" \
   "$pnfam_path/betadecay.x >> test_output_pnfam.out" \
